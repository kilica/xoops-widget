...
**/
class Widget_AdminRenderSystem extends Legacy_AdminRenderSystem
{
    /**
     * prepare
     * 
    ...
    **/
    public function renderTheme(/*** XCube_RenderTarget ***/ &$target)
    {
        ...
        $info = Widget_AdminRenderSystem::getOverrideFileInfo('admin_theme.html');
        $this->mSmarty->template_dir = ($info['file'] != null) ?
            substr($file['path'],0,-15) :
            WIDGET_ADMIN_RENDER_FALLBACK_PATH;
    ...
    **/
    ...
    {
        $info = Widget_AdminRenderSystem::getOverrideFileInfo($target->getTemplateName());
    ...
    **/
    public static function getOverrideFileInfo(/*** string ***/ $file,/*** string ***/ $prefix = null,/*** bool ***/ $isSpDirName = false)
    {
        ...
        {
            $handler =& Widget_Utils::getXoopsHandler('module');
        ...
        switch(true)
        {
            ...
            case $isModule && file_exists(
                ...
                $ret['dirname'] = $trustDirName;
                return $ret;
            case file_exists($path = WIDGET_ADMIN_RENDER_FALLBACK_PATH . '/' .$file):
                $ret['url'] = WIDGET_ADMIN_RENDER_FALLBACK_URL . '/' . $file;
                $ret['path'] = $path;
                $ret['theme'] = null;
                $ret['dirname'] = null;
                return $ret;
    ...
    **/
    ...
    {
        $info = Widget_AdminRenderSystem::getOverrideFileInfo($str);
        if($info['url'] != null)
        {
            return $info['url'];
        }
        return WIDGET_ADMIN_RENDER_FALLBACK_URL . '/' . $str;
    }
    ...
    **/
    public static function functionStylesheet(/*** {string 'file',string 'media'} ***/ $param,/*** Smarty ***/ &$smarty)
    {
        ...
        $info = Widget_AdminRenderSystem::getOverrideFileInfo($params['file'],'stylesheets/');
        if($info['file'] == null)
        {
            return;
        }
